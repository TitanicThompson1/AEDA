...
void test_A_() {
	...
	ASSERT_EQUAL<int>(3, e1.getConsultants().size());
	Expertize e2 = organization.getExpertize("Data Science", 100);
	ASSERT_EQUAL<int>(1, e2.getConsultants().size());
	Expertize e3 = organization.getExpertize("OOP", 40);
	ASSERT_EQUAL<int>(1, e3.getConsultants().size());
	Expertize e4 = organization.getExpertize("OOP", 100);
	ASSERT_EQUAL<int>(0, e4.getConsultants().size());
